...
<body>
	<main class="form-login w-100 m-auto">
		<form class="text-center" action="<%=url%>/login-servlet"
			method="POST" autocomplete="off">
			<img class="mb-4"
				src="<%= request.getContextPath() %>/asset/img/logo/logo.png" alt=""
				width="72">
			...
			<p class="mt-5 mb-3">&copy;2025 WomTechShop. All rights reserved.</p>
		</form>
	</main>
	<script
