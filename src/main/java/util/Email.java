...
public class Email {
	...
	public static void sendResetPasswordEmail(String to, String name, String resetLink) {
		...
		String content = "Click vào liên kết bên dưới để đặt lại mật khẩu:<br><a href='" + resetLink
				+ "'>Đặt lại mật khẩu</a>";
		Email emailService = new Email();
		String html = emailService.buildEmail(name, title, content);
		sendEmail(to, title, html);
	...
	public static void sendOrderConfirmationEmail(String to, String name, String orderId, String orderDate,
			String total) {
	...
	public static void sendOTPEmail(String to, String name, String otpCode, int validMinutes) {
		String title = "Mã xác thực OTP của bạn";
		String content = """
				Mã OTP của bạn là: <strong style="font-size: 20px;">%s</strong><br>
				Mã này có hiệu lực trong <strong>%d phút</strong>. Vui lòng không chia sẻ mã này với bất kỳ ai.
	...
	public static void main(String[] args) {
		...
		//sendOTPEmail("23110181@student.hcmute.edu.vn","Nguyễn Quân Bảo","123456",5);
	}
}